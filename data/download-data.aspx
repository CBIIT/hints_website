...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                ...
                <div class="col-md-12">
                    ...
                    <div id="dv_data" runat="server" class="TermsHidden">
                        ...
                        <div class="filter-controls">
                            ...
                            <button type="button" class="filter-trigger" data-target="pad">Publicly Available Datasets</button>
                            <button type="button" class="filter-trigger" data-target="cad">Controlled-Access Datasets</button>
                        </div>
                        ...
                        <div class="content-section" data-category="cad">
    ...
    <script src="/_scripts/datamergingcode/downloaddata.js"></script>
