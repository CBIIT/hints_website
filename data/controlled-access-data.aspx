...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script src="/_scripts/datamergingcode/controlledaccessdata.js"></script>
    <link rel="stylesheet" href="/css/controlledaccessdata.css">
</asp:Content>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ul>
                        ...
                        <li>Request Access: To request access to HDLP 2024 data, please visit the <a href="https://dbgap.ncbi.nlm.nih.gov/beta/study/phs004213.v1.p1/#study" target="_blank">HDLP 2024 dbGaP page</a>. To review HDLP 2024 data details, please visit the <a href="https://general.datacommons.cancer.gov/#/study/phs004213" target="_blank">HDLP 2024 GC page</a>.</li>
                    </ul>
                    ...
                    <ul>
                        ...
                        <li>Request Access: To request access to HDLP 2022 data, please visit the <a href="https://dbgap.ncbi.nlm.nih.gov/beta/study/phs004214.v1.p1/#study" target="_blank">HDLP 2022 dbGaP page</a>. To review HDLP 2022 data details, please visit the <a href="https://general.datacommons.cancer.gov/#/study/phs004214" target="_blank">HDLP 2022 GC page</a>.</li>
                    </ul>
                    ...
                    <ul>
                        ...
                        <li>Request Access: To request access to HINTS-SEER data, please visit the <a href="https://dbgap.ncbi.nlm.nih.gov/beta/study/phs004065.v1.p1/#study" target="_blank">HINTS-SEER  dbGaP page</a>. To review HINTS-SEER data details, please visit the <a href="https://general.datacommons.cancer.gov/#/study/phs004065" target="_blank">HINTS-SEER GC page</a>. 
                    </ul>
                    ...
                    <ul>
                        ...
                        <li>Request Access: To request access to HDLP 2020 data, please visit the <a href="https://dbgap.ncbi.nlm.nih.gov/beta/study/phs004215.v1.p1/#study" target="_blank">HDLP 2020 dbGaP page</a>. To review HDLP 2020 data details, please visit the <a href="https://general.datacommons.cancer.gov/#/study/phs004215" target="_blank">HDLP 2020 GC page</a>.</li></li>
                    </ul>
                    ...
                    <ul>
                        ...
                        <li>View Data Details: To view more details about these datasets, please use the GC links below.</li>
                            <ul>
                                <li><a href="https://general.datacommons.cancer.gov/#/study/phs004216" target="_blank">HINTS 5, Cycle 3 GC page</a></li>
                                <li><a href="https://general.datacommons.cancer.gov/#/study/phs004217" target="_blank">HINTS 5, Cycle 2 GC page</a></li>
                                <li><a href="https://general.datacommons.cancer.gov/#/study/phs004210" target="_blank">HINTS 5, Cycle 1 GC page</a></li>
                                <li><a href="https://general.datacommons.cancer.gov/#/study/phs004209" target="_blank">HINTS 4, Cycle 4 GC page</a></li>
                                <li><a href="https://general.datacommons.cancer.gov/#/study/phs004208" target="_blank">HINTS 4, Cycle 3 GC page</a></li>
                                <li><a href="https://general.datacommons.cancer.gov/#/study/phs004207" target="_blank">HINTS 4, Cycle 2 GC page</a></li>
                                <li><a href="https://general.datacommons.cancer.gov/#/study/phs004212" target="_blank">HINTS 4, Cycle 1 GC page</a></li>
                            </ul>
                    </ul>
                    ...
                    <div class="accordion">
                        <h3>
                            <button type="button" aria-expanded="false" class="accordion-trigger" aria-controls="sec_noEmp" id="accordion1id">
                                <span class="accordion-title">
                                    <span class="accordion-title-text"><strong>Non-NIH Employees</strong></span>
                                    <span class="accordion-icon"></span>
                                </span>
                            </button>
                        </h3>
                        <div id="sec_noEmp" role="region" aria-labelledby="accordion1id" class="accordion-panel" hidden="">
                    ...
                    <div class="accordion">
                        <h3>
                            <button type="button" aria-expanded="false" class="accordion-trigger" aria-controls="sec_nihEmp" id="accordion2id">
                                <span class="accordion-title">
                                    <span class="accordion-title-text"><strong>NIH Employees</strong></span>
                                    <span class="accordion-icon"></span>
                                </span>
                            </button>
                        </h3>
                        <div id="sec_nihEmp" role="region" aria-labelledby="accordion2id" class="accordion-panel" hidden="">
                    ...
                    <p><strong>If a requestor is not a PI (e.g., student; other non-faculty position), they would need to make a request through a PI. Can the PI then share the data with them? </strong></p>
                    <p>Yes, the student/trainee's advisor or senior PI would need to submit the data access request, and through their controls designate their student/trainee as a data downloader. Here is a link to instructions about how to do that through dbGaP: <a href="https://www.ncbi.nlm.nih.gov/books/NBK570248/#Dwnld_DownloadData.i_am_a_data_analyst_w" target="_blank"></a>NCBI - WWW Error Blocked Diagnostic</p>

                    <p><strong>Can a person who is not affiliated with an institution (e.g., small business owner working with an institution) request and receive the data?</strong></p>
                    <p>Yes, small companies are permitted to submit data access requests. However, they can only be approved if the PI is verified as having oversight responsibilities and their company has the appropriate security infrastructure.</p>
