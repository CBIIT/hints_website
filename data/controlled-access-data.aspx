            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ul>
                        ...
                        <li>Request Access: To request access to HINTS-SEER data, please visit the <a href="https://www.ncbi.nlm.nih.gov/projects/gap/cgi-bin/study.cgi?study_id=phs004065.v1.p1" target="_blank">HINTS-SEER page within NLM's dbGaP system</a>. To review HINTS-SEER data details, please visit the <a href="https://general.datacommons.cancer.gov/#/study/phs004065" target="_blank">HINTS-SEER GC page</a>.</li>
                    </ul>
                    ...
                    <ul>
                        ...
                        <li>Request Access: To request access to these datasets, please visit the dbGaP links below.
                            <ul>
                    ...
                    <ol>
                        <li>Confirm you meet the pre-requisites for requesting data
                            <ol type="a">
                                <li>There are several pre-requisites for requesting data via dbGaP, so please check that that you:
                                    <ol>
                                        <li>Are permanent member of your institution and have an institutional email.</li>
                        ...
                        <li>Prepare the Data Request
                            <ol type="a">
                                ...
                                <li>e.	Select “Begin New Research Project.” We strongly recommend reviewing the instructions prior to creating a new request.</li>
                                ...
                                <li>Fill out various sections of the submission form, which include project title, research use statement, non-technical summary, signing official, internal collaborators, and IT director.</li>
                                <li>Review information on data use certifications, restrictions on use, limitations on use, and various other documentation, then submit your application.</li>
                                <li>You will then be able to submit your application.</li>
                        ...
                        <li>Data Access Committee (DAC) request review
                            <ol type="a">
                                <li>Each dataset has a DAC, a group of experts who review the request for compliance with NIH policy and the appropriateness of the request with respect to the dataset.</li>
                                <li>If a request is approved, you will receive an email with additional instructions on accessing the dataset.</li>
                                <li>If a request is denied, you can review your submission and re-submit. There are <a href="https://www.ncbi.nlm.nih.gov/books/n/helpdbgap/DAreq_ReviseAmndUpd/#DAreq_ReviseAmndUpd.Revise_Data_Access_R" target="_blank">specific steps for resubmission</a>.</li>
                            </ol>
                        </li>
                        <li>Accessing the Data
                            <ol type="a">
                                <li>If a data request is approved via dbGaP, you will be referred to NCI’s General Commons to access the data.</li>
                            </ol>
                        </li>
                    </ol>
                    ...
                    <ol>
                        ...
                        <li>Prepare the Data Request
                            <ol type="a">
                                <li>Once your your permission form is approved, you will be registered in the dbGaP system as an approved user and will be notified by email when you can proceed to submit data access requests to dbGaP.</li>
                                ...
                                <li>Under “My Projects,” select “Create New Research Project.”</li>
                                <li>Select “Begin New Research Project.”</li>
                                ...
                                <li>You will review data use certifications, restrictions on use, limitations on use, and various other documentation, then submit your application.</li>
                                <li>You will then be able to submit your application.</li>
                                <li>Once a data request is submitted, it is routed to your institution’s IC’ssigning official for review, approval, and co-signature.</li>
                                <li>For tips on preparing a submission, please visit this <a href="https://grants.nih.gov/sites/default/files/flmngr/Tips for Preparing a Successful DAR.pdf" target="_blank">dbGaP Tip Sheet</a>. </li>
                            </ol>
                        </li>
                        <li>Data Access Committee (DAC) request review
                            <ol type="a">
                                <li>Each dataset has a DAC, a group of experts who review the request for compliance with NIH policy and the appropriateness of the request with respect to the dataset.</li>
                                <li>If a request is approved, you will receive an email with additional instructions on accessing the dataset.</li>
                                <li>If a request is denied, you can adjust the submission and re-submit. There are <a href="https://www.ncbi.nlm.nih.gov/books/n/helpdbgap/DAreq_ReviseAmndUpd/#DAreq_ReviseAmndUpd.Revise_Data_Access_R" target="_blank">specific steps for resubmission</a>.</li>
                            </ol>
                        </li>
                        <li>Accessing the data
                            <ol type="a">
                    ...
                    <h2 id="AD_GC"><strong>Accessing Data via General Commons</strong></h2>
                    ...
                    <ol>
                        ...
                        <li>If this is your first time signing into General Commons, you will need to fill in the user information, as well as read and agree to the Terms of Service and Privacy Policy before pressing "Proceed to the CGC."</li>
                        <li>You will then be prompted to choose a destination project. You should click "Create new project" and assign it a name.</li>
                        <li>Read the usage information and click the "I understand…" button and then press import data. </li>
                        <li>Once data have been imported, you can toggle to "Projects" in the upper left hand corner. Click on the project you have created.</li>
                        <li>Next to "Dashboard" (upper left-hand corner), you can click on "Files."</li>
                        <li>Here, you will find the HINTS data files you put into your cart.</li>
                        <li>Using the checkbox option to the left of each named data file, you may click to select the files. Selecting the files allows you to  copy, rename, move, and download them.</li>
                    </ol>
