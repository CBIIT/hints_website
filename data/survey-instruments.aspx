<%@ Page Title="Survey Materials &amp; Methods Reports | HINTS" Language="VB" MasterPageFile="~/hintsmain.master" AutoEventWireup="false" CodeFile="survey-instruments.aspx.vb" Inherits="datafolder_survey_instruments" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <meta name="Title" content="Survey Materials &amp; Methods Reports | HINTS" />
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="container col-lg-12 col-xl-7 col custom-wrapper">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ul>
                        ...
                        <li><a href="#FDAc2">HINTS-FDA, Cycle 2 (2017) Survey Materials</a></li>
                        <li><a href="#FDA2015">HINTS-FDA (2015) Survey Materials</a></li>
                        <li><a href="#H4C4">HINTS 4, Cycle 4 (2014) Survey Materials</a></li>
                        <li><a href="#H4C3">HINTS 4, Cycle 3 (2013) Survey Materials</a></li>
                        <li><a href="#H4C2">HINTS 4, Cycle 2 (2012) Survey Materials</a></li>
                        <li><a href="#H4C1">HINTS 4, Cycle 1 (2011) Survey Materials</a></li>
                        <li><a href="#HINTSPR2009">HINTS Puerto Rico 2009</a></li>
                        <li><a href="#HINTS3">HINTS 3 (2008) Survey Materials</a></li>
                        <li><a href="#HINTS2">HINTS 2 (2005) Survey Materials</a></li>
                        <li><a href="#HINTS1">HINTS 1 (2003) Survey Materials</a></li>
                    </ul>
                    ...
                    <h2 id="HDLP2024">
                        <strong>HINTS Data Linkage Project 2024 (HDLP 2024) </strong></h2>
                    <p>The HINTS Data Linkage Project 2024 (HDLP 2024) contains geo-coded HINTS 7 (2024; n = 7,278) linked with numerous external variables to support analyzing linked data to enhance the types of analyses and corresponding research questions that can be answered with HINTS data. The linkage was done at both the census tract and county level using geo-coded HINTS 7 data. External variables were chosen from trusted and reliable sources including the US Census, the Agency for Healthcare Research and Quality (AHRQ), the US Department of Agriculture (USDA), and the Centers for Disease Control and Prevention (CDC). The external variables fall into five categories: 1) Social and economic factors; 2) Demographics (e.g., Percent of population 65 or older); 3) Information technology (e.g., Percent of households with broadband internet); 4) Built environment (e.g., Fitness centers and recreational sports centers per 100,000 people); and 5) Physical environment (e.g., Percentage of days with good air quality). The HINTS Data Linkage Project 2024 (HDLP 2024) External Variables codebook, which includes a list of all external variables and links to many of the original data sources, is available for download below.</p>

                    <p><strong>HINTS Data Linkage Project 2024 (HDLP 2024) External Variables Codebook: </strong>(<a href="/docs/Instruments/HINTS_2024_HDLP_ External_Variables_Codebook.pdf" target="_blank">PDF</a> 0.8MB)</p>
                    ...
                    <p><strong>HINTS Data Linkage Project 2022 (HDLP 2022) External Variables Codebook: </strong>(<a href="/docs/Instruments/HINTS_2022_HDLP_ External_Variables_Codebook.pdf" target="_blank">PDF</a> 0.6MB)</p>
                    ...
                    <ul>
                        ...
                        <li><strong>HINTS 7 (2024) Methodology Report:</strong> (<a href="/docs/methodologyreports/HINTS_7_MethodologyReport.pdf" target="_blank">PDF</a> 3.4 MB)</li>
                    </ul>
                    ...
                    <ul>
                        <li><strong>HINTS-FDA (2015) Full-content, English Version:</strong>  (<a href="/docs/Instruments/HINTS_FDA_English_Annotated_Survey.pdf" target="_blank">PDF</a>  1,137KB)</li>
                        <li><strong>HINTS-FDA (2015) Methodology Report:</strong>  (<a href="/docs/Instruments/HINTS-FDA_Methodology_Report.pdf" target="_blank">PDF</a> 590 KB)</li>
                        <li><strong>HINTS-FDA (2015) Full-content, Spanish Version:</strong>  (<a href="/docs/Instruments/HINTS_FDA_Spanish_Annotated_Survey.pdf" target="_blank">PDF</a>  758 KB)</li>
                    </ul>
                    ...
                    <ul>
                        <li><strong>HINTS 4, Cycle 4 (2014) Full-content, English Version:</strong> (<a href="/docs/Instruments/HINTS_4_Cycle_4_English_Annotated_Form.pdf" target="_blank">PDF</a> 971 KB)</li>
                        <li><strong>HINTS 4, Cycle 4 (2014) Methodology Report:</strong> (<a href="/docs/Instruments/HINTS_4_Cycle_4_Methodology_Report_Final.pdf" target="_blank">PDF</a> 2.2 MB)</li>
                        <li><strong>HINTS 4, Cycle 4 (2014) Full-content, Spanish Version:</strong> (<a href="/docs/Instruments/HINTS_Cycle_4_Spanish_Full_Annotated_Form.pdf" target="_blank">PDF</a> 476 KB)</li>
                        <li><strong>HINTS 4, Cycle 4 (2014) Reduced-content, Spanish Version:</strong> (<a href="/docs/Instruments/HINTS_Cycle_4_Spanish_Reduced_Annotated_Form.pdf" target="_blank">PDF</a> 495 KB)</li>
                    </ul>
                    ...
                    <p>The sample design for the HINTS 4, Cycle 3 (2013) survey consisted of two-stages. In the first stage, a stratified sample of addresses was selected from a file of residential addresses. In the second-stage, one adult was selected within each sampled household. The sampling frame consisted of a database of addresses used by Marketing Systems Group (MSG) to provide random samples of addresses. Complete data were collected from 3,185 respondents.</p>

                    <ul>
                        <li><strong>HINTS 4, Cycle 3 (2013) Full-content, English Version:</strong> (<a href="/docs/Instruments/HINTS_4_Cycle_3_English_Annotated_508c_3_21_2014.pdf" target="_blank">PDF</a> 1 MB)</li>
                        <li><strong>HINTS 4, Cycle 3 (2013) Methodology Report:</strong> (<a href="/docs/Instruments/HINTS_4_Cycle_3_Methods_Report_FINAL_508c_03_21_2014.pdf" target="_blank">PDF</a> 652 KB)</li>
                        <li><strong>HINTS 4, Cycle 3 (2013) Full-content, Spanish Version:</strong> (<a href="/docs/Instruments/HINTS_4_Cycle_3_Spanish_Full_Annotated_508c.pdf" target="_blank">PDF</a> 628 KB)</li>
                        <li><strong>HINTS 4, Cycle 3 (2013) Reduced-content, Spanish Version:</strong> (<a href="/docs/Instruments/HINTS_4_Cycle_3_Spanish_Reduced_Annotated_508c.pdf" target="_blank">PDF</a> 2 MB)</li>
                    </ul>
                    ...
                    <p>The sample design for the HINTS 4, Cycle 2 (2012) survey consisted of two-stages. In the first stage, a stratified sample of addresses was selected from a file of residential addresses. In the second-stage, one adult was selected within each sampled household. The sampling frame consisted of a database of addresses used by Marketing Systems Group (MSG) to provide random samples of addresses. Complete data were collected from 3,630 respondents.</p>


                    <ul>
                        <li><strong>HINTS 4, Cycle 2 (2012) Full-content, English Version:</strong> (<a href="/docs/Instruments/HINTS_4_Cycle_2_English.pdf" target="_blank">PDF</a> 814 KB)</li>
                        <li><strong>HINTS 4, Cycle 2 (2012) Full-content, Spanish Version:</strong> (<a href="/docs/Instruments/HINTS_4_Cycle_2_Spanish.pdf" target="_blank">PDF</a> 540 KB)</li>
                        <li><strong>HINTS 4, Cycle 2 (2012) Methodology Report:</strong> (<a href="/docs/Instruments/HINTS_4_Cycle2_Methods_Report.pdf" target="_blank">PDF</a> 533 KB)</li>
                    </ul>
                    ...
                    <p>Two methods of respondent selection were used for  HINTS 4, Cycle 1 (2011): the “All Adult” method and the “Next Birthday” method. In the All Adult method, two questionnaires were sent with each mailing, where all adults residing in a sampled household were asked to complete the questionnaire. In the next birthday method, one questionnaire was sent with each mailing so that the adult who would have the next birthday in the sampled household was asked to complete the questionnaire. Data were collected from 3,959 respondents.</p>

                    <p>Refer to the <a href="/docs/HINTS4_Cycle1_Methods_Report_revised_Jun2012.pdf" target="_blank">HINTS 4, Cycle 1 (2011) Methodology Report</a> for more information about the design, testing, and implementation of the HINTS 4, Cycle 1 (2011) survey. You may also download the <a id='hyp_instruments_download_inner_One' runat="server" href="~/data/survey-instruments.aspx#openModal">complete dataset</a>.</p>
                    <ul>
                        <li><strong>All-Adult, Full-content, English Version:</strong> (<a href="/docs/Instruments/HINTS4Cycle1_AAFullContentEnglishSurvey.pdf" target="_blank">PDF</a> 777 KB)</li>
                        <li><strong>All-Adult, Reduced-content, English Version:</strong> (<a href="/docs/Instruments/HINTS4Cycle1_AAReducedContentEnglishSurvey.pdf" target="_blank">PDF</a> 716 KB)</li>
                        <li><strong>Next-Birthday, Full-content, English Version:</strong> (<a href="/docs/Instruments/HINTS4Cycle1_NBFullContentEnglishSurvey.pdf" target="_blank">PDF</a> 779 KB)</li>
                        <li><strong>Next-Birthday, Reduced-content, English Version:</strong> (<a href="/docs/Instruments/HINTS4Cycle1_NBReducedContentEnglishSurvey.pdf" target="_blank">PDF</a> 531 KB)</li>
                        <li><strong>Next-Birthday, Full-content, Spanish Version:</strong> (<a href="/docs/Instruments/HINTS4Cycle1_NBFullContentSpanishSurvey.pdf" target="_blank">PDF</a> 715 KB)</li>
                        <li><strong>Next-Birthday, Reduced-content, Spanish Version:</strong> (<a href="/docs/Instruments/HINTS4Cycle1_NBReducedContentSpanishSurvey.pdf" target="_blank">PDF</a> 590 KB)</li>
                    </ul>
                    ...
                    <ul>
                        <li><strong>HINTS Puerto Rico  2009 Final Report:</strong> (<a href="/docs/Instruments/HINTS-PR_Final_Report.pdf" target="_blank">PDF</a> 191 KB)</li>
                        <li><strong>HINTS Puerto Rico 2009 Extended Interview Instrument (Spanish):</strong> (<a href="/docs/Instruments/HINTS-PR_instrument_SPA.pdf" target="_blank">PDF</a> 319 KB)</li>
                        <li><strong>English language full instrument not available.</strong></li>
                    </ul>
                    ...
                    <p>
                        See the Final Report  below for more information about the design, testing, and implementation of the HINTS 3 (2008) survey.  You may also
        <asp:Label ID="Label1" runat="server" Text="download the complete dataset"></asp:Label>.
                    </p>
                    <ul>
                        <li><strong>HINTS 3 (2008) Final Report:</strong> (<a href="/docs/Instruments/HINTS2007FinalReport.pdf" target="_blank">PDF</a> 1 MB)</li>
                        <li><strong>HINTS 3 (2008) Mail Instrument:</strong> (<a href="/docs/Instruments/HINTS 2007 Annotated Mail Instrument.pdf" target="_blank">PDF</a> 404 KB)</li>
                        <li><strong>HINTS 3 (2008) CATI Instrument (English)</strong> (<a href="/docs/Instruments/HINTS 2007 CATI Instrument (English).pdf" target="_blank">PDF</a> 445 KB)</li>
                        <li><strong>HINTS 3 (2008) CATI Instrument (Spanish)</strong> (<a href="/docs/Instruments/HINTS 2007 CATI Instrument (Spanish).pdf" target="_blank">PDF</a> 450 KB)</li>
                    </ul>
        ...
        <asp:Label ID="Label2" runat="server" Text="download the complete dataset"></asp:Label>.
                    ...
                    <ul>
                        <li><strong>HINTS 2 (2005) Final Report:</strong> (<a href="/docs/Instruments/HINTS_2005_Final_Report.pdf" target="_blank">PDF</a> 208 KB)</li>
                        <li><strong>HINTS 2 (2005) Main Survey Instrument (English):</strong> (<a href="/docs/Instruments/HINTS_2005_Instrument-English.pdf" target="_blank">PDF</a> 510 KB)</li>
                        <li><strong>HINTS 2 (2005) Main Survey Instrument (Spanish):</strong> (<a href="/docs/Instruments/HINTS_2005_Instrument-Spanish.pdf" target="_blank">PDF</a> 475 KB)</li>
                    </ul>
                    ...
                    <p>
                        Materials describing the first administration of the survey are available for download. You may also
        <asp:Label ID="Label3" runat="server" Text="download the complete dataset"></asp:Label>
                    </p>
                    <ul>
                        <li><strong>HINTS 1 (2003) Final Report:</strong> (<a href="/docs/Instruments/HINTS_2003_final_report.pdf" target="_blank">PDF</a> 1 MB)</li>
                        <li><strong>HINTS 1 (2003) Survey Instrument (English):</strong> (<a href="/docs/Instruments/HINTS_2003_Instrument-English.pdf" target="_blank">PDF</a> 448 KB)</li>
                        <li><strong>HINTS 1 (2003) Survey Instrument (Spanish):</strong> (<a href="/docs/Instruments/HINTS_2003_Instrument-Spanish.pdf" target="_blank">PDF</a> 451 KB)</li>
                    </ul>

                    <p>Learn about mode, trends and more in the <a href="/about-hints/frequently-asked-questions.aspx">HINTS FAQ</a>.</p>
