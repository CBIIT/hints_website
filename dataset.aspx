<%@ Page Title="Public Use Dataset" Language="VB" MasterPageFile="~/Main.master" AutoEventWireup="false"
    CodeFile="dataset.aspx.vb" Inherits="dataset" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <p>
        For additional information about using HINTS data, please use our <a href="contact_us.aspx">contact form</a> or email <a href="mailto:NCIhints@mail.nih.gov">NCIhints@mail.nih.gov</a>.
    </p>
</asp:Content>
