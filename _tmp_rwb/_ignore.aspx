<%@ Page Language="VB" AutoEventWireup="false" CodeFile="_ignore.aspx.vb" Inherits="_tmp_rwb_ignore" %>
...
<body>
    ...
    <asp:Repeater ID="RPTR" runat="server">
        ...
        <tr>
            ...
            <td>
                <asp:HyperLink Target="_blank" Visible='<%# CheckVis(Eval("FileName"))%>' NavigateUrl='<%# "_view_sub.aspx?PK_Submission=" & Eval("PK_Submission").ToString%>' ID="HyperLink1" runat="server"><%# Eval("FileName")%></asp:HyperLink></td>
