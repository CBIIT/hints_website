            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ul>
                        ...
                        <li><a href="#accordion-2">How can these data be used for planning in cancer control?</a></li>
                        <li><a href="#accordion-3">How are the survey instruments created?</a></li>
                        <li><a href="#accordion-4">What are the response rates for the available HINTS data?</a></li>
                        <li><a href="#accordion-5">What geographic units of analysis are possible in HINTS?</a></li>
                        <li><a href="#accordion-6">Do I need permission to use the data?</a></li>
                        <li><a href="#accordion-7">Can I use these items in my own survey or research?</a></li>
                        <li><a href="#accordion-8">How do I contact the program?</a></li>
                        <li><a href="#accordion-9">What publications/presentations already exist?</a></li>
                        <li><a href="#accordion-10">What journals would you recommend for HINTS studies?</a></li>
                        <li><a href="#accordion-11">Where can I find information on sampling procedures?</a></li>
                        <li><a href="#accordion-12">What are the limitations of the data?</a></li>
                        <li><a href="#accordion-13">The response rate of some HINTS surveys is below 35%. What procedures were used to reach sampled individuals? Are the HINTS data nationally representative?</a></li>
                        <li><a href="#accordion-14">How is HINTS different from other surveys?</a></li>
                        <li><a href="#accordion-15">What is the jackknife replicate weight type used in HINTS?</a></li>
                        <li><a href="#accordion-15-2">Interested in International or Community HINTS?</a></li>
                    </ul>

                    <h2>Questions about mode</h2>
                    <ul>
                        <li><a href="#accordion-16">What is the "mode"?</a></li>
                        ...
                        <li><a href="#accordion-24">If there are no mode effects for an item, can I always combine data collected by both modes?</a></li>
                    </ul>

                    <h2>Questions about trends</h2>
                    <ul>
                        <li><a href="#accordion-25">If HINTS data are cross-sectional, how can I look at trends over time?</a></li>
                        <li><a href="#accordion-26">How many ways can I examine trends over time?</a></li>
                        <li><a href="#accordion-27">If, in my analysis, I do not observe any changes over time for HINTS items, may I combine data across HINTS years to increase my sample size?</a></li>
                    ...
                    <div class="accordion">
                        ...
                        <div class="accordion-section" id="accordion-5">
                            <strong>What geographic units of analysis are possible in HINTS?</strong>
                        ...
                        <div class="accordion-section" id="accordion-7">
                            <strong>Can I use these items in my own survey or research?</strong>
                        ...
                        <div class="accordion-section" id="accordion-8">
                            <strong>How do I contact the program?</strong>

                            <div>
                                <p>For information about the HINTS program, please use our <a href="/about-hints/contact-us.aspx">contact form</a> or email <a href="mailto:NCIhints@mail.nih.gov">NCIhints@mail.nih.gov</a>.</p>
                            </div>
                            <!--end .accordion-section-content-->
                        </div>
                        <!--end .accordion-section-->
                        <div class="accordion-section" id="accordion-9">
                            <strong>What publications/presentations already exist?</strong>

                            <div>
                                <p>For a full list of HINTS-related publications and presentations, go to <a href="/research.aspx">https://hints.cancer.gov/research.aspx</a>.</p>
                            </div>
                            <!--end .accordion-section-content-->
                        </div>
                        <!--end .accordion-section-->
                        <div class="accordion-section" id="accordion-10">
                            ...
                            <div>
                                <p>A full list of peer-reviewed journals that have published HINTS studies can be found at <a href="/publications-reports/hints-journals.aspx">https://hints.cancer.gov/publications-reports/hints-journals.aspx</a>.</p>
                            </div>
                            <!--end .accordion-section-content-->
                        </div>
                        <!--end .accordion-section-->
                        ...
                        <div class="accordion-section" id="accordion-13">
                            <strong>The response rate of some HINTS surveys is below 35%. What procedures were used to reach sampled individuals? Are the HINTS data nationally representative?</strong>

                            <div>
                                <p>HINTS is a postal survey based on a stratified probability-based sample of the U.S. adult, civilian, non-institutionalized population. The sample is drawn in two stages. The first stage randomly selects addresses from the United States Postal Service file of residential addresses. The second stage selects an adult within the selected household using the next birthday method. Survey weights are created to permit analysts to generalize the results to the national population of U.S. adults. The first step to create these weights is an adjustment to reflect the selection probabilities. To compensate for non-response and coverage error, the selection weights are calibrated using data from the American Community Survey conducted by the U.S. Census Bureau. HINTS non-response historically has been correlated with being male, young, a minority, having less education and being Hispanic. The calibration therefore uses age, gender, educational attainment, race, ethnicity and Census region to adjust for this pattern. An analysis conducted on earlier rounds of HINTS found that non-response is also negatively correlated with access to health care and to health status. Those who have had less access to health care services and who have had fewer health problems were less likely to respond to the survey. To compensate for these patterns, insurance status and cancer status are used as additional calibration adjustments. The data to make this adjustment were taken from the National Health Interview Survey. Because HINTS is conducted with a random sample of adults and weighted to the U.S. population, the data are considered nationally representative.</p>
                                <p>To maximize the response rate and the representativeness of the sample, the survey includes multiple non-response follow-ups, a pre-paid incentive at the first mailing, and express delivery as one of the non-response follow-up mailings. A Spanish version of the questionnaire is distributed to households in high minority census tracts.</p>
                            </div>
                            <!--end .accordion-section-content-->
                        </div>
                        <!--end .accordion-section-->
                        ...
                        <div class="accordion-section" id="accordion-15">
                            <strong>What is the jackknife replicate weight type used in HINTS?</strong>
                        ...
                        <!--end .accordion-section-->
                        <div class="accordion-section" id="accordion-15-2">
                            <strong>Interested in International or Community HINTS?</strong>
                    ...
                    <div class="accordion">
                        <div class="accordion-section" id="accordion-16">
                            <strong>What is the "mode"?</strong>
                        ...
                        <div class="accordion-section" id="accordion-18">
                            <strong>Why was HINTS 3 (2007) collected using 2 modes?</strong>
                        ...
                        <div class="accordion-section" id="accordion-24">
                            <strong>If there are no mode effects for an item, can I always combine data collected by both modes?</strong>
                    ...
                    <div class="accordion">
                        ...
                        <div class="accordion-section" id="accordion-26">
                            <strong>How many ways can I examine trends over time?</strong>
                        ...
                        <!--end .accordion-section-->
                        <div class="accordion-section" id="accordion-29">
                            <strong>How can I tell if an item is appropriate to examine in trends analyses?</strong>
                        ...
                        <!--end .accordion-section-->
                        <div class="accordion-section" id="accordion-30">
                            <strong>Do I need to consider differences in response rates or sample demographics when examining trends across HINTS years?</strong>
                        ...
                        <!--end .accordion-section-->
                        <div class="accordion-section" id="accordion-33">
                            <strong>Where do I find information about how composite variables were created and other changes to the data? </strong>
