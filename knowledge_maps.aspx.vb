...
Partial Class knowledge_maps
        ...
        If Not Page.IsPostBack Then
            ...
            Else
                ...
                Else
                    ...
                    hyp_publink.HRef = "articles-by-question.aspx?PK_Question=" & FK_Question & "&ArtType=1"
                End If
                Cmd.Parameters.Clear()
                ...
                Else
                    ...
                    hyp_brieflink.HRef = "articles-by-question.aspx?PK_Question=" & FK_Question & "&ArtType=2"
                End If
                Cmd.Parameters.Clear()
    ...
    Private Function breadcrumbsKMHandler(ByVal sender As Object, ByVal e As SiteMapResolveEventArgs) As SiteMapNode
        ...
        If sectionName.Length > 0 Then
            ...
            newNode2 = New SiteMapNode(SiteMap.Provider, "question", "~/question-details.aspx?PK_Question=" & FK_Question)
