<%@ Page Title="HINTS: Analytic Methods to Examine Changes Across Years Using HINTS 2003 &amp; 2005 Data" Language="VB" MasterPageFile="~/Main.master" AutoEventWireup="false" CodeFile="users_data_handbook_accessible.aspx.vb" Inherits="users_data_handbook_accessible" %>
...
<div id="page_wrapper" class="grid">
    ...
    <p>Weights are assigned to account for all of the stages of selection (from the RDD sampling frame and within the household), and for attrition from noncontacts, screener nonresponse, and interview nonresponse. These weights are designed to provide approximately unbiased estimators of population totals using a modified Horvitz-Thompson estimator (see for example Cochran 1977, Section 9A.7)<sup><a href="#foot5">5</a></sup>. Replicate weights are also provided to allow for consistent variance estimation. The replicate weights for all of the biennial HINTS surveys are based on the jackknife replication method, with R = 50 replicate weights for each survey year. The replicate weights are formed by deleting a carefully selected portion of the original sample (roughly 1/50 of the original sample), and reweighting the remaining sample as if the complement set was the full sample. Estimates are computed using each set of replicate weights, generating a set of parallel replicate estimates to the estimate of interest. The sum of squares of the deviations between the replicate estimates and the &#8216;full-sample&#8217; estimate, with appropriate adjustment, provides consistent estimators of the variance. For example, suppose <img src="_images/thetahat.jpg" alt="theta-hat" width="7" height="13" /> is an estimator (a percentage within a subgroup, for example) using the &#8216;fullsample&#8217; weights. We generate replicate estimators <img src="_images/thetahat.jpg" alt="theta-hat" width="7" height="13" /><sub>r</sub> in parallel, doing the calculation in the same way, but using each set of replicate weights in place of the original full-sample weights. The jackknife variance estimator of <img src="_images/thetahat.jpg" alt="theta-hat" width="7" height="13" /> is</p>
    <p align="center"><img src="_images/scientific_equations.jpg" alt="v sub r of theta hat equals R minus 1 divided by R times the summation over r from 1 to R of theta hat sub r minus theta hat, quantity squared" width="173" height="47" /></p>
    
    <p>Final methodology reports are available for both HINTS 2003 and HINTS 2005 and are accessible online at no cost on <a href="http://hints.cancer.gov">http://hints.cancer.gov</a>. These reports provide details of the sampling and weighting for the respective surveys. This methodology paper is closely based on a similar methodology paper (Lee, et al. 2007) for the California Health Information Survey (CHIS).</p> 
    ...
    <table class="tblStyle">
      <tr>
        <th rowspan="2" valign="bottom" align="left">&nbsp;<br />
      ...
      <tr>
        <td><strong>Education Level</strong><br />
        Less than high school</td>
        <td>&nbsp;<br />
        6.5%</td>
        <td>&nbsp;<br />
        1.4%</td>
      ...
      <tr>
        <td><strong>Annual Income</strong><br />
        Less than $25,000</td>
        <td>&nbsp;<br />
        10.1%</td>
        <td>&nbsp;<br />
    ...
    <p>It is easy to produce an estimate of change in characteristics between 2003 and 2005 and its corresponding variance estimate, because HINTS samples are drawn independently. Here we will label HINTS 2003 &#34;year 1&#34; and HINTS 2005 &#34;year 2,&#34; and consider estimating a characteristic <em>&#952;</em> (e.g., a mean, percentage, regression coefficient, population standard deviation) in year s. We label the true value in year <em>s</em> as <em>&#952;</em><sub>s</sub>, the estimated value as <img src="_images/thetahat.jpg" alt="theta-hat" width="7" height="13" /><sub>s</sub>, and the estimated variance (the square of the standard error) as <em>&#957;(<img src="_images/thetahat.jpg" alt="theta-hat" width="7" height="13" /><sub>s</sub>)</em>.  The true change between years is &#916;=<em>&#952;</em><sub>2</sub>-<em>&#952;</em><sub>1</sub>, with consistent estimator <img src="_images/deltahat.jpg" alt="delta-hat" width="7" height="12" />=<img src="_images/thetahat.jpg" alt="theta-hat" width="7" height="13" /><sub>2</sub>-<img src="_images/thetahat.jpg" alt="theta-hat" width="7" height="13" /><sub>1</sub></p>
    ...
    <p align="center"><em>&#957;</em>(<img src="_images/deltahat.jpg" alt="delta-hat" width="7" height="12" />)=<em>&#957;</em>(<img src="_images/thetahat.jpg" alt="theta-hat" width="7" height="13" /><sub>1</sub>)+<em>&#957;</em>(<img src="_images/thetahat.jpg" alt="theta-hat" width="7" height="13" /><sub>2</sub>)</p>
    ...
    <table class="tbl3-1Style">
      <tr>
        <th align="left" width="13%" scope="col">Year</th>
        <th align="left" width="13%">True Value</th>
        <th align="left" width="13%">Estimated Value</th>
        <th align="left" width="21%">Variance of Estimate</th>
      </tr>
      <tr>
        <td>1</td>
        <td><em>&#952;</em><sub>1</sub></td>
        <td><img src="_images/thetahat.jpg" alt="theta-hat" width="7" height="13" /><sub>1</sub></td>
        <td><em>&#957;</em>(<img src="_images/thetahat.jpg" alt="theta-hat" width="7" height="13"><sub>1</sub>)</td>
      </tr>
      <tr>
        <td>2</td>
        <td><em>&#952;</em><sub>2</sub></td>
        <td><img src="_images/thetahat.jpg" alt="theta-hat" width="7" height="13" /><sub>2</sub></td>
        <td><em>&#957;</em>(<img src="_images/thetahat.jpg" alt="theta-hat" width="7" height="13"><sub>2</sub>)</td>
      </tr>
      <tr>
        <td>Change</td>
        <td>&#916;=<em>&#952;</em><sub>2</sub>-<em>&#952;</em><sub>1</sub></td>
        <td><img src="_images/deltahat.jpg" alt="delta-hat" width="7" height="12">=<img src="_images/thetahat.jpg" alt="theta-hat" width="7" height="13" /><sub>2</sub>-<img src="_images/thetahat.jpg" alt="theta-hat" width="7" height="13" /><sub>1</sub></td>
        <td><em>&#957;</em>(<img src="_images/deltahat.jpg" alt="delta-hat" width="7" height="12">)=<em>&#957;</em>(<img src="_images/thetahat.jpg" alt="theta-hat" width="7" height="13"><sub>1</sub>)-<em>&#957;</em>(<img src="_images/thetahat.jpg" alt="theta-hat" width="7" height="13"><sub>2</sub>)</td>
      </tr>
    </table>
    ...
    <p align="center"><img src="_images/scientific_equations-2.jpg" alt="d hat equals delta hat divided by the square root of the estimated variance of delta hat" width="85" height="63" /></p>
    ...
    <p><strong>Table 3-2 Estimates of differences of percentages of adults who have ever looked for cancer information online,
between 2003 and 2005.</strong></p>
    
    <table class="tblStyle">
      <tr>
        <th width="20%" valign="bottom" align="left"><strong>SUBGROUP</strong></th>
        <th width="10%">2003 Weighted Estimate<br />
        <img src="_images/thetahat-lg.jpg" alt="theta-hat" width="9" height="17"><sub>1</sub></th>
        <th width="10%">Standard Error<br />
        ...
        <th width="10%">2005 Weighted Estimate<br />
        ...
        <th width="10%">Estimate of 2003 to 2005 Change<br /><img src="_images/deltahat-lg.jpg" alt="delta-hat" width="10" height="15"></th>
        <th width="10%">Standard Error<br />
        <img src="_images/scientific_equations-5.jpg" alt="square root of estimated variance of delta hat" width="44" height="24"></th>
        <th width="10%">Two-sided p-value of Test of No Change<sup><a href="#foot8">8</a></sup></th>
        <th width="10%">One-sided p-value of Test of No Change<sup><a href="#foot8">8</a></sup></th>
      </tr>
      <tr>
        <td>ALL</td>
        <td>19.7% </td>
    ...
    <p>One can compute one-sided or two-sided confidence intervals of the difference using similar considerations. The two-sided confidence interval will be<br />
    <div align="center"><img src="_images/scientific_equations-6.jpg" alt="delta hat plus or minus t sub [{alpha divided by two} comma degrees of freedom] times the square root of the estimated variance of theta hat; square root of the estimated variance of delta hat" width="119" height="33"></div>
    </p>
    ...
    <table class="tblStyle">
      <tr>
        <th valign="bottom" width="25%" align="left"><strong>SUBGROUP</strong></th>
        <th width="18%"><strong>Estimate of 2003 to 2005 Change</strong><br />
        <img src="_images/deltahat-lg.jpg" alt="delta-hat" width="10" height="15"></th>
        <th width="19%"><strong>Standard Error</strong><br />
        <img src="_images/scientific_equations-5.jpg" alt="square root of estimated variance of delta hat" width="44" height="25"></th>
        <th width="19%"><strong>Lower Bound 95% C.I.</strong></th>
        <th width="19%"><strong>Upper Bound 95% C.I.</strong></th>
      </tr>
      <tr>
        <td>ALL</td>
        <td>8.6%</td>
    ...
    <p>It is also necessary to define a YEAR field equal to 2003 (or 1) for HINTS 2003 sample members, and equal to 2005 (or 2) for HINTS 2005 sample members. The Goal 1 <img src="_images/deltahat.jpg" alt="delta-hat" width="7" height="12"> = <img src="_images/thetahat.jpg" alt="theta-hat" width="7" height="13"><sub>2</sub> - <img src="_images/thetahat.jpg" alt="theta-hat" width="7" height="13"><sub>1</sub>, with corresponding standard errors, test statistics, and confidence intervals, can be easily (and correctly) estimated from this combined data set using a contrast with the YEAR field (+1 for HINTS 2005 records and -1 for HINTS 2003 records). Appendix A provides SAS syntax for computing the new replicate weights<sup><a href="#foot9">9</a></sup> and SUDAAN syntax for calculating the estimate of the difference<sup><a href="#foot10">10</a></sup>. Appendix B provides corresponding STATA code<sup><a href="#foot11">11</a></sup>.</p>
    
    <p><strong>Table 4 Construction of statistical weights for the combined data file.</strong></p>
    
    <table class="tbl4Style">
      <tr>
        <th align="left" width="13%" scope="col">&nbsp;</th>
        <th align="left" width="13%">Final Sample Weight</th>
        <th align="left" width="13%">Replicate Weights 1-50</th>
        <th align="left" width="21%">Replicate Weights 51-100</th>
      </tr>
      <tr>
        <td><strong>Hints 2003</strong></td>
        <td>2003 Final Weight (FWGT)</td>
        <td>2003 Replicate Weights (FWGT1-FWGT50)</td>
        <td>2003 Final Weight (FWGT)</td>
      </tr>
      <tr>
        <td><strong>Hints 2005</strong></td>
        <td>2005 Final Weight (FWGT)</td>
        <td>2005 Final Weight (FWGT)</td>
        <td>2005 Replicate Weights (FWGT1-FWGT50)</td>
      </tr>
      <tr>
        <td><strong>Combined Data</strong></td>
        <td>Final Weight (NFWGT)</td>
        <td>Final Replicate Weights (NFWGT1-NFWGT50)</td>
        <td>Final Replicate Weights (NFWGT51-NFWGT100)</td>
      </tr>
    </table>
    ...
    <table class="tblStyle">
      <tr>
        <th valign="bottom" width="30%" align="left">SUBGROUP</th>
        <th width="14%">Beta Coefficient</th>
        <th width="14%">Standard Error Beta Coefficient</th>
        <th width="14%">Odds Ratio</th>
        <th width="14%">Lower Bound 95% CI Odds Ratio</th>
        <th width="14%">Upper Bound 95% CI Odds Ratio</th>
      </tr>
      <tr>
      ...
      <tr>
        <td><strong>SURVEY YEAR</strong><br />
        2003</td>
        <td>&nbsp;<br />
        0.00</td>
        <td>&nbsp;<br />
    ...
    <table class="tblStyle">
      ...
      <tr>
        <td><strong>EDUCATION LEVEL 2003</strong><br />
        Less than high school</td>        
        <td>&nbsp;<br />
        -1.97</td>
        <td>&nbsp;<br />
      ...
      <tr>
        <td><strong>EDUCATION LEVEL 2005 VS 2003</strong><br />
        Less than high school</td>        
        <td>&nbsp;<br />
        -0.52</td>
        <td>&nbsp;<br />
    ...
    <table class="tbl4Style">
      <tr>
        <th align="left" width="15%" scope="col">Year</th>
        <th align="left" width="15%">True Value</th>
        <th align="left" width="15%">Estimated Value</th>
        <th align="left" width="25%">Variance of Estimate</th>
      </tr>
      <tr>
        <td>1</td>
        <td><em>&#952;</em><sub>1</sub></td>
      ...
      <tr>
        <td>Average</td>
        <td><em>&#952;</em><sub>m</sub>= 0.5* (<em>&#952;</em><sub>2</sub>-<em>&#952;</em><sub>1</sub>)</td>
        <td><img src="_images/thetahat.jpg" alt="theta-hat" width="7" height="13">= 0.5* (<img src="_images/thetahat.jpg" alt="theta-hat" width="7" height="13" /><sub>1</sub>+<img src="_images/thetahat.jpg" alt="theta-hat" width="7" height="13" /><sub>2</sub>)</td>
        <td><em>&#957;</em>(<img src="_images/deltahat.jpg" alt="delta-hat" width="7" height="12">)= 0.25* (<em>&#957;</em>(<img src="_images/thetahat.jpg" alt="theta-hat" width="7" height="13"><sub>1</sub>)+<em>&#957;</em>(<img src="_images/thetahat.jpg" alt="theta-hat" width="7" height="13"><sub>2</sub>))</td>
      </tr>
    </table>
    ...
    <table class="tblStyle">
      <tr>
        ...
        <th width="10%">Standard Error<br />
        <img src="_images/scientific_equations-4.jpg" alt="square root of the estimated variance of theta hat 2" width="44" height="24"></th>
        <th width="10%">2003 to 2005 Average<br />
        <img src="_images/scientific_equations-7.jpg" alt="{theta hat 1 plus theta hat 2} divided by two"></th>
        <th width="10%">Standard Error</th>
        <th width="10%">Lower Bound 95% CI</th>
        <th width="10%">Upper Bound 95% CI</th>
      </tr>
      <tr>
        <td>ALL</td>
        <td>19.7%</td>
    ...
    <table class="tblStyle">
      <tr>
        <th width="25%" valign="bottom" align="left"><strong>SUBGROUP</strong></th>
        <th width="11%">2003 Weighted Estimate</th>
        <th width="11%">Standard Error</th>
        <th width="11%">2005 Weighted Estimate</th>
        <th width="11%">Standard Error</th>
        <th width="11%">2003 to 2005 <em>&#952;</em><sub>w</sub> Estimate</th>
        <th width="10%">Lower Bound 95% CI</th>
        <th width="10%">Upper Bound 95% CI</th>
      </tr>
      <tr>
    ...
    <p class="small">
        ...
        <a id="foot15"></a><sup>15</sup>For example, for dichotomous response variables, if one uses the svy: mean or svy: proportion command then the confidence interval will be symmetric. If one uses the svy: tabulate command the confidence interval will be asymmetric (it uses the logit transform).</p>
    ...
    <p>/*HINTS Data - SAS Transport Files &#38; Format Files*/<br />
   ...
   <p> data combined;<br />
    ...
    HC9SeekCancerInfo HC20UseInternet HC27LastOnlineHealth HC29InternetForCancer)<br /><br />
    
    hints2(in=in2 keep=spgender spage RaceEthn HHIncB EducA fwgt fwgt1-fwgt50 bmi<br />
    CA12WhereLookCancerInfo CA08SeekCancerInfo GA1UseInternet CA15InternetForCancer );</p>
    
    <p>label srvyYear=&#34;Survey Year&#34;;<br />
    if in1 then srvyYear=1;**2003;<br />
    else if in2 then srvyYear=2;**2005;<br />
    format srvyYear yearf.;</p>
    ...
    <p>label race=&#8216;Race/Ethnicity&#8217;;<br />
   ...
   <p>label income=&#8216;Household Income&#8217;;<br />
    ...
    <p>/*InternetForCancer Recode - All Respondents*/<br />
   ...
   <p> else if srvyYear=2 then do;**2005 Recode;<br />
    ...
    format InternetForCancer yesno.;</p>
    
    <p>/*Adjust Replicate Weights for the combined dataset*/<br />
    ...
    <p>else if srvyYear=2 then do;***2005;<br />
    newwgts[i] = fwgt;<br />
    ...
    <p><strong>/*Test for total difference across years using combined dataset.*/<br />
    ...
    <p><strong>/*View percentages by specified years using combined dataset.*/<br />
    ...
    <p><strong>/*Test for differences across years for a subset of demographic va riables using combined dataset.*/<br />
    ...
    <p><strong>/*Assess differences across years while controlling for cova riates&#151;education, age, and gender&#151;using the combined dataset. See Table 5-1.*/</strong><br />
    ...
    <p><strong>/*Assess differences across years while controlling for cova riates&#151;education, age, and gender&#151;using the combined dataset. Includes an interaction term to test for differential change by levels of education. <a href="#5_2">See Table 5-2</a>.*/</strong><br />
    proc rlogist data= combined design=jackknife ddf=99;<br />
    weight nfwgt;<br />
    jackwgts nfwgt1-nfwgt100 / adjjack=.98;<br />
    class srvyYear educ age sex/nofreq;<br />
    ...
    <p><strong>/*Assess differences across years for each level of education while controlling for age and gender.*/<br />
    ...
    <p>proc rlogist data= combined design=jackknife ddf=99;<br />
    weight nfwgt;<br />
    jackwgts nfwgt1-nfwgt100 / adjjack=.98;<br />
    ...
    <p><strong>/*Obtain weighted percentages by demographic subgroup using combined dataset. See Table 6-3.*/</strong><br />
    proc descript data= combined design=jackknife ddf=99;<br />
    weight nfwgt;<br />
    jackwgts nfwgt1-nfwgt100 / adjjack=.98;<br />
    class srvyYear age educ sex income race InternetForCancer/nofreq;<br />
    ...
    <p>log using &#34;&#60;insert file path name&#62;\data step.log&#34;, replace<br />
    set memory 512m<br />
    ...
    label variable srvyyear &#34;Survey Year&#34;</p>
    
   <p> *** Create the demographic variables<br />
    recode spgender (1=1 &#34;Male&#34;) (2=2 &#34;Female&#34;), generate(sex)<br />
    label variable sex &#34;Gender&#34;</p>
    
    <p>recode spage (18/34=1 &#34;18-34&#34;) (35/49=2&#34;"35-49") (50/64=3 &#34;50-64&#34;) (65/96=4 &#34;65 +&#34;) (nonmissing=.),<br />
    generate(age)<br />
    label variable age &#34;Age Group&#34;</p>
    
    <p>recode raceethn (1=3 &#34;Hispanic&#34;) (2=1 &#34;NH White&#34;) (3=2 &#34;NH Black&#34;) (4/7=4 &#34;NH Other&#34;) (nonmissing=.),<br />
    generate(race)<br />
    label variable race &#34;Race/Ethnicity&#34;</p>
    
    <p>recode hhincb (1=1 &#34;&#60;$25K&#34;) (2 3=2 &#34;$25K-&#60;$50K&#34;) (4=3 &#34;$50K-&#60;$75K&#34;) (5=4 &#34;$75K &#34;) (nonmissing=.),<br />
    generate(income)<br />
    label variable income &#34;Household Income&#34;</p>
    
    <p>recode educa (1=1 &#34;Less than High School Grad&#34;) (2=2 &#34;High School Grad&#34;) (3=3 &#34;Some College&#34;) (4=4 &#34;College Grad&#34;) (nonmissing=.), generate(educ)<br />
    label variable educ &#34;Education&#34;</p>
    
    <p>* Create the variable internetforcancer<br />
    ...
    * Respondents who have used the internet for general health information<br />
    ...
    label variable internetforcancer "Have you ever specifically looked for cancer info online?"</p>
    
    <p>* Create the replicate weights for the combined data<br />
    generate nfwgt = fwgt</p>
    
    <p>foreach i of numlist 1/50 {<br />
    generate nfwgt&#8216;i&#8217; = fwgt&#8216;i&#8217;<br />
    }</p>
    
    <p>foreach i of numlist 51/100 {<br />
   ...
   <p> * Create the demographic variables<br />
    ...
    generate(income)<br />
    recode educa (1=1 &#34;Less than High School Grad&#34;) (2=2 &#34;High School Grad&#34;) (3=3 &#34;Some College&#34;) (4=4 &#34;College Grad&#34;) (nonmissing=.), generate(educ)</p>
    
    <p>* Create the variable internetforcancer<br />
    generate internetforcancer = .</p>
    
    <p>* Respondents whose last search for cancer information was online<br />
    replace internetforcancer = 1 if ca12wherelookcancerinfo == 7</p>
    
    <p>* Respondents who never looked for health information online<br />
    replace internetforcancer = 0 if missing(internetforcancer) &#38; (ca08seekcancerinfo == 2 | ga1useinternet == 2)</p>
    
    <p>* Respondents who have used the internet for general health information
    replace internetforcancer = 2 - ca15internetforcancer if missing(internetforcancer) &#38; (ca15internetforcancer == 1 | ca15internetforcancer == 2)</p>
    ...
    <p>*In Stata 10, the user can not specify the design degrees of freedom.<br />
    log using &#34;&#60;insert file path name&#62;\analysis step.log&#34;, replace<br />
    set memory 512m<br />
    use &#34;&#60;insert file path name&#62;\combined.dta&#34;, clear<br />
    svyset [pw=nfwgt], jkrw(nfwgt1-nfwgt100, multiplier(0.98)) vce(jack) mse</p>
    
    <p><strong>GOAL 1&#8212;Estimating Changes Without Controlling for Other Factors. (<a href="#3">See section 3</a>.)</strong></p>
    
    <p>***The following codes recreate the yearly percentages, differences, standard errors, and two-sided p-<br />
    ...
    * Test for differences across years using combined data -- overall<br />
    ...
    lincom [internetforcancer]2 - [internetforcancer]1</p>
    
    <p>* Test for differences across years using combined data -- by age group<br />
    * among non-missing age<br />
    ...
    drop selectedgroup</p>
    
    <p>* among those with age 18-34<br />
    generate selectedgroup = (age == 1) if !missing(age)<br />
    svy, subpop(selectedgroup): mean internetforcancer, over(srvyyear)<br />
    lincom [internetforcancer]2 - [internetforcancer]1<br />
    drop selectedgroup</p>
    
    <p>* among those with age 35-49<br />
    generate selectedgroup = (age == 2) if !missing(age)<br />
    svy, subpop(selectedgroup): mean internetforcancer, over(srvyyear)<br />
    lincom [internetforcancer]2 - [internetforcancer]1<br />
    drop selectedgroup</p>
    
    <p>* among those with age 50-64<br />
    generate selectedgroup = (age == 3) if !missing(age)<br />
    svy, subpop(selectedgroup): mean internetforcancer, over(srvyyear)<br />
    lincom [internetforcancer]2 - [internetforcancer]1<br />
    drop selectedgroup</p>
    
    <p>* among those with age 65+<br />
    generate selectedgroup = (age == 4) if !missing(age)<br />
    svy, subpop(selectedgroup): mean internetforcancer, over(srvyyear)<br />
    lincom [internetforcancer]2 - [internetforcancer]1<br />
    drop selectedgroup</p>
    
   <p> * Test for differences across years using combined data -- by education group<br />
    * among non-missing education<br />
    ...
    <p>* among those less than high school<br />
    generate selectedgroup = (educ == 1) if !missing(educ)<br />
    svy, subpop(selectedgroup): mean internetforcancer, over(srvyyear)<br />
    lincom [internetforcancer]2 - [internetforcancer]1<br />
    drop selectedgroup</p>
    
    <p>* among those high school graduate<br />
    generate selectedgroup = (educ == 2) if !missing(educ)<br />
    svy, subpop(selectedgroup): mean internetforcancer, over(srvyyear)<br />
    lincom [internetforcancer]2 - [internetforcancer]1<br />
    drop selectedgroup</p>
    
    <p>* among those some college<br />
    generate selectedgroup = (educ == 3) if !missing(educ)<br />
    svy, subpop(selectedgroup): mean internetforcancer, over(srvyyear)<br />
    lincom [internetforcancer]2 - [internetforcancer]1<br />
    drop selectedgroup</p>
    
    <p>* among those college graduate<br />
    generate selectedgroup = (educ == 4) if !missing(educ)<br />
    svy, subpop(selectedgroup): mean internetforcancer, over(srvyyear)<br />
    lincom [internetforcancer]2 - [internetforcancer]1<br />
    drop selectedgroup</p>
    
    <p>* Test for differences across years using combined data -- by sex<br />
    * among non-missing sex<br />
    ...
    <p>* Test for differences across years using combined data -- by income group<br />
   ...
   <p> * among NH other<br />
    ...
    <p>*** Logistic Regression &#150; adjusted by education, age and sex. (<a href="#5_1">Table 5-1</a>)<br />
    ...
    xi: svy, or: logit internetforcancer i.srvyyear i.educ i.age i.sex</p>
    
    <p>*** Logistic Regression -- adjusted by education, age, sex and i.srvyyear*i.educ. (Table 5-2)<br />
    ...
    xi: svy, or: logit internetforcancer i.srvyyear i.educ i.age i.sex i.srvyyear*i.educ</p>
    
    <p>*** Logistic Regression &#150; adjusted by age and sex, stratified by education. (Table 5-3)<br />
    * among those less than high school<br />
    ...
    test _Isrvyyear_2, nosvyadjust<br />
    test _Iage_1 _Iage_2 _Iage_3, nosvyadjust<br />
    test _Isex_1, nosvyadjust</p>
    
    <p><strong>GOAL 2&#8212;Estimating Changes Controlling for Other Factors. (<a href="#5">See section 5</a>.)</strong></p>
    
    <p>xi: svy, or subpop(selectedgroup): logit internetforcancer i.srvyyear i.age i.sex<br />
    drop selectedgroup</p>
    ...
    <p>*** Obtain weighted percentages using combined dataset. (<a href="#6_3">Table 6-3</a>)<br />
    * Estimate using the combined data by age group<br />
    svy: tabulate age internetforcancer, row se ci format(%8.5f) percent</p>
    
    <p>* Estimate using the combined data by education group<br />
    svy: tabulate educ internetforcancer, row se ci format(%8.5f) percent</p>
    
    <p>* Estimate using the combined data by sex group<br />
    svy: tabulate sex internetforcancer, row se ci format(%8.5f) percent</p>
    
    <p>* Estimate using the combined data by income group<br />
    svy: tabulate income internetforcancer, row se ci format(%8.5f) percent</p>
    
    <p>* Estimate using the combined data by race group<br />
    svy: tabulate race internetforcancer, row se ci format(%8.5f) percent</p>
    ...
    <p>For purposes of computing appropriate degrees of freedom for the estimator of HINTS 2003 and HINTS 2005 differences (and of combinations in general such as averages across years), we can assume as an approximation that both samples are simple random samples of size 50 (corresponding to the 50 replicates: each replicate provides a &#8216;pseudo sample unit&#8217;) from a normal distribution<sup>16</sup>. We have independent estimates <img src="_images/thetahat.jpg" alt="theta-hat" width="7" height="13"><sub>1</sub> and <img src="_images/thetahat.jpg" alt="theta-hat" width="7" height="13"><sub>2</sub> with means <em>&#952;</em><sub>1</sub> and <em>&#952;</em><sub>2</sub> and variances Var(<img src="_images/thetahat.jpg" alt="theta-hat" width="7" height="13"><sub>1</sub>) and Var(<img src="_images/thetahat.jpg" alt="theta-hat" width="7" height="13"><sub>2</sub> with means <em>&#952;</em><sub>1</sub>). The estimator of the difference &#916;=<em>&#952;</em><sub>2</sub>-<em>&#952;</em><sub>1</sub> is <img src="_images/deltahat.jpg" alt="delta-hat" width="7" height="12"> = <img src="_images/thetahat.jpg" alt="theta-hat" width="7" height="13"><sub>2</sub>-<img src="_images/thetahat.jpg" alt="theta-hat" width="7" height="13"><sub>1</sub>, with estimator of variance v(<img src="_images/deltahat.jpg" alt="delta-hat" width="7" height="12">) = v(<img src="_images/thetahat.jpg" alt="theta-hat" width="7" height="13"><sub>1</sub>) +v (<img src="_images/thetahat.jpg" alt="theta-hat" width="7" height="13"><sub>2</sub>). v(<img src="_images/thetahat.jpg" alt="theta-hat" width="7" height="13"><sub>1</sub>) and v(<img src="_images/thetahat.jpg" alt="theta-hat" width="7" height="13"><sub>2</sub>) have n<sub>1</sub> - 1 and n<sub>2</sub> - 1 degrees of freedom respectively<sup>17</sup>, where n<sub>1</sub> and n<sub>2</sub> are the number of replicates for year 1 and year 2 respectively. The estimating equation referred to the t-distribution in this case is <img src="_images/scientific_equations-8.jpg" alt="delta hat minus delta divided by the square root of the sum of the estimated variances of theta hat 1 and theta hat 2" width="100" height="19">. The method for computing the degrees of freedom of the difference of normally-distributed simple random sample estimators with unequal variances from independent surveys is taken from Bickel and Doksum (1977). Section 6.4C recommends the Welch approximation, which computes as the degrees of freedom k for the estimating equation <img src="_images/scientific_equations-8.jpg" alt="delta hat minus delta divided by the square root of the sum of the estimated variances of theta hat 1 and theta hat 2" width="100" height="19"><br />
      <br />
    
    <img src="_images/scientific_equations-9.jpg" alt="k equals the inverse of the summation of {c-squared divided by (n sub 1 minus 1)} and {1 minus c quantity squared divided by (n sub 2 minus 1)}" width="141" height="49" align="middle"> where <img src="_images/scientific_equations-10.jpg" alt="c equals the estimated variance of theta hat 1 divided by {the estimated variance of theta hat 1 plus the estimated variance of theta hat 2}" width="111" height="58" align="middle">.</p>
    
    <p>In our application n<sub>1</sub> and n<sub>2</sub> are both 50. If v(<img src="_images/thetahat.jpg" alt="theta-hat" width="7" height="13"><sub>1</sub>) and v(<img src="_images/thetahat.jpg" alt="theta-hat" width="7" height="13"><sub>2</sub>) are also both equal, then c = 1/2 and<br /><br />
    
    <img src="_images/scientific_equations-11.jpg" alt="k equals the inverse of [the summation of {one-half squared divided by 49} and {one-half squared divided by 49}] which equals 98" width="187" height="52"></p>
    
    <p>That is the maximum value of k. If v(<img src="_images/thetahat.jpg" alt="theta-hat" width="7" height="13"><sub>1</sub>) is much smaller, or much larger, than v(<img src="_images/thetahat.jpg" alt="theta-hat" width="7" height="13"><sub>2</sub>), then<br /><br />
    <img src="_images/scientific_equations-12.jpg" alt="; k approximately equals the inverse of one squared divided by 49 which equals 49" width="118" height="64">.</p>
    
    <p>49 is the minimum value of k. Thus 49 is the &#8216;conservative&#8217; approximation for the degrees of freedom: it gives the widest confidence intervals (using the t distribution on 49 degrees of freedom). If v(<img src="_images/thetahat.jpg" alt="theta-hat" width="7" height="13"><sub>1</sub>) and v(<img src="_images/thetahat.jpg" alt="theta-hat" width="7" height="13"><sub>2</sub>) are unequal and both in the same order of magnitude, then Welch's approximation value can be used to generate an appropriate k, which will be in the range [49,98].</p>
    
    <p class="small"><sup>16</sup>The pseudo-values may not necessarily have a normal distribution: it is good practice to check this assumption and make sure there is not kurtosis which may reduce the effective degrees of freedom.<br />
    <sup>17</sup>It actually may be smaller if for a particular statistic many of the replicates are effectively equal to the full-sample estimator. 49 is actually the maximum in general.</p>
    ...
    <p><strong>NCI's Cancer Information Service (CIS)</strong><br />
    ...
    TDD: 1-800-332-8615</p>
    
    <p><strong>Other NCI or DHHS Sources of Cancer Information</strong><br />
    ...
    Office of Communications: <a target="_blank" href="http://www.cancer.gov/aboutnci/office-of-communications/page3">www.cancer.gov/aboutnci/office-of-communications/page3</a></p>
    
    <p><strong>American Cancer Society (ACS)</strong><br />
    <a target="_blank" href="http://www.cancer.org/docroot/home/index.asp">www.cancer.org/docroot/home/index.asp</a></p>
    
    <p><strong>FEDERALLY-SPONSORED PROGRAM PLANNING RESOURCES</strong></p>
    
    <p><strong>Cancer Control P.L.A.N.E.T.</strong><br />
    <a target="_blank" href="http://cancercontrolplanet.cancer.gov/">http://cancercontrolplanet.cancer.gov/</a></p>
    
    <p><strong>Research-tested Intervention Programs (RTIPs)</strong><br />
    <a target="_blank" href="http://rtips.cancer.gov/rtips/index.do">http://rtips.cancer.gov/rtips/index.do</a></p>
    
    <p><strong>Guide to Community Preventive Services</strong><br />
    <a target="_blank" href="http://www.thecommunityguide.org/">www.thecommunityguide.org/</a><a href="exit_disclaimer.aspx"><img src="_images/Icon_External_Link.png" width="12" height="12" alt="Exit Disclaimer" border="0" /></a></p>
    
    <p><strong>RESEARCH TOOLS AND RESOURCES</strong></p>
    
    <p><strong>Behavioral Risk Factor Surveillance System (BRFSS)</strong><br />
    <a target="_blank" href="http://www.cdc.gov/brfss/">www.cdc.gov/brfss/</a></p>
    
    <p><strong>National Health Interview Survey (NHIS)</strong><br />
    <a target="_blank" href="http://www.cdc.gov/nchs/nhis.htm">www.cdc.gov/nchs/nhis.htm</a></p>
    
    <p><strong>Current Population Survey (CPS)</strong><br />
    <a target="_blank" href="http://www.census.gov/cps/">www.census.gov/cps/</a></p>
    
    <p><strong>Surveillance, Epidemiology, and End Results (SEER)</strong><br />
    <a target="_blank" href="http://seer.cancer.gov/">http://seer.cancer.gov/</a></p>
    
    <p><strong>Pew Internet and American Life Project</strong><br />
    <a target="_blank" href="http://www.pewinternet.org/data.asp">http://www.pewinternet.org/data.asp</a><a href="exit_disclaimer.aspx"><img src="_images/Icon_External_Link.png" width="12" height="12" alt="Exit Disclaimer" border="0" /></a></p>
    
    <p align="right"><a href="#">Back to top</a></p>
    
    <hr />
        
    <p>Health Information Natitonal Survey (HINTS)<br />
    <a target="_blank" href="http://hints.cancer.gov">hints.cancer.gov</a></p>
    
    <p>U.S. Department of Health and Human Services (DHHS)<br />
    National Institutes of Health (NIH)<br />
    National Cancer Institute (NCI)</p>
    
    <p>NIH Publication No. 08-6435<br />
    Printed June 2008</p>
    </div>
</div>
</asp:Content>