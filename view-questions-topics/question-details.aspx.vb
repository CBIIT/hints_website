...
Partial Class questionsfolder_question_details
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            If Cmd.ExecuteScalar() > 0 Then
                ...
                HYP_Briefs_ByAllQuestion.NavigateUrl = "~/view-questions-topics/articles-by-question.aspx?ArtType=2&PK_Question=" & QuestionID
            Else
