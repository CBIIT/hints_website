<%@ Page Title="How to Merge HINTS Data Video Series | HINTS" Language="VB" MasterPageFile="~/hintsmain.master" AutoEventWireup="false" CodeFile="how-to-merge-hints-data.aspx.vb" Inherits="meetings_trainings_how_to_merge_hints_data" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <meta name="Title" content="How to Merge HINTS Data Video Series | HINTS" />
    <meta name="Description" content="Dr. Rick Moser, lead HINTS methodologist at the National Cancer Institute (NCI), narrates a series of videos that demonstrate how to merge data from HINTS." />
</asp:Content>
        ...
        <section>
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h1>How to Merge HINTS Data Video Series</h1>
